...
public class MyViewHolder
{
     ...
     * @return
     */
    public MyViewHolder setImageByUrl(String url,ImageView imageView,boolean isDown,AsyncImageLoader.ImageCallback callback){
        AsyncImageLoader.getInstance(context).downloadImage(url,imageView,isDown,
                callback);
        return this;
    }
