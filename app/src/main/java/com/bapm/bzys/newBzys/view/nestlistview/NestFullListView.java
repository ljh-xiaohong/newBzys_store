package com.bapm.bzys.newBzys.view.nestlistview;
 ...
 * 时间： 2016/9/9.
 */
public class NestFullListView extends AutoLinearLayout {
    ...
    //清除緩存并刪除旧的view
    public void removedCahce(){
        mVHCahces.removeAll(mVHCahces);
        if (mAdapter!=null) {
            removeViews(0, mAdapter.getDatas().size());
        }
    }
...
//                        holder = new NestFullViewHolder(getContext(), mInflater.inflate(mAdapter.getItemLayoutId(), this, false));
                        ...
                        Log.e("mVHCahces",mVHCahces.size()+"");
                    }
