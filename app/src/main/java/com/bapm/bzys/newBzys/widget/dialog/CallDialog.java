...
public class CallDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public CallDialog create() {
            ...
            final CallDialog dialog = new CallDialog(context, R.style.Dialog);
            View layout = inflater.inflate(R.layout.activity_book_information_calldialog, null);
            ...
            layout.findViewById(R.id.content).setOnClickListener(new View.OnClickListener() {
                ...
                Uri data = Uri.parse("tel:" + "400-8891884");
                intent.setData(data);
