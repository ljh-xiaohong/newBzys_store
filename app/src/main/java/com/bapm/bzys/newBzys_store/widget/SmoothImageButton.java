 ...
 * 
 */
public class SmoothImageButton extends ImageButton {
	...
	public SmoothImageButton(Context context) {
		super(context);
		init();
	}

	public SmoothImageButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public SmoothImageButton(Context context, AttributeSet attrs, int defStyle) {
