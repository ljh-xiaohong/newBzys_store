...
import com.bapm.bzys.newBzys_store.fragment.FragmentOrderDetail;
...
public class MainOrderActivity extends FragmentActivity {
	...
	private void showToolsView() {
		...
		for (int i = 0; i < toolsList.length; i++) {
			View view = inflater.inflate(R.layout.activity_order_list_type_item, null);
			view.setId(i);
			view.setOnClickListener(toolsItemListener);
			TextView tv_type_name = (TextView) view
					.findViewById(R.id.tv_type_name);
			tv_type_name.setText(toolsList[i]);
